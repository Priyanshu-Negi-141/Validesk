...
const instrumentSchema = new Schema({
  instrument: {
    ...
    accuracy: { type: String, required: true },
    least_count: { type: String, required: true },
    visual_inspection: { type: String, required: true },
    calibrate_at: { type: String, required: true },
    temperature: { type: String, required: true },
    relative_humidity: { type: String, required: true },
    cal_procedure: { type: String, required: true },
    supporting_standards: { type: String, required: true },
    zero_error: { type: String, required: true },
    calibration_date: { type: String, required: true },
